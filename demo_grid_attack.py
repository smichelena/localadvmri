...
import config
from config_grid_attack import (OpA, get_grid,
                                spatial_grid_attack,
...
Yadv = spatial_grid_attack(Y,noise_rel,width=width,n_locs=n_locs,iter=5,method=method)
...
path_fig = os.path.join(config.path_to_results,"demo_grid_attack.pdf")
